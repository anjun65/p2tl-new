...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('form_tidak_langsung_data_pemeriksaan_pelindung_cts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_tidak_langsung_data_pemeriksaan_pelindung_cts');
    }
};

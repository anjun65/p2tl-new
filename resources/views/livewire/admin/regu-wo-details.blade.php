                ...
                <div class="py-4 space-y-4">
                    <div class="flex justify-between">
                        <div class="w-2/4 flex space-x-4">
                            ...
                            <x-button.link wire:click="toggleShowFilters">@if ($showFilters) Sembunyikan @endif Pencarian Lebih Lanjut...</x-button.link>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-200 p-4 rounded shadow-inner flex relative">
                            ...
                            <div class="w-1/2 pl-4 space-y-4">
                                ...
                                <x-input.group inline for="filter-min_tanggal_inspeksi" label="Minimum Tanggal Inspeksi">
                                    <x-datepicker wire:model="filters.min_tanggal_inspeksi" id="filter-min_tanggal_inspeksi">
                                    </x-datepicker>
                                </x-input.group>

                                <x-input.group inline for="filter-max_tanggal_inspeksi" label="Maximum Tanggal Inspeksi">

...
use App\Models\FormLangsungPemeriksaanPelindungBusBar as form_model;
use App\Helpers\ResponseFormatter;
use Illuminate\Support\Facades\Storage;

class FormLangsungPemeriksaanPelindungBusbar extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($form){
            $form->update([
                ...
                'foto_sebelum' => Storage::putFileAs('public/assets/dataPemeriksaan/busbar/sebelum', $request->foto_sebelum, 'foto_sebelum_'.$request->forms_id.'.'.$request->foto_sebelum->getClientOriginalExtension()),
                ...
                'foto_sesudah' => Storage::putFileAs('public/assets/dataPemeriksaan/busbar/sesudah', $request->foto_sesudah, 'foto_sesudah_'.$request->forms_id.'.'.$request->foto_sesudah->getClientOriginalExtension()),
            ]);
        } else {

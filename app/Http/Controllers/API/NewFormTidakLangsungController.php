...
class NewFormTidakLangsungController extends Controller
{
    public function store(Request $request)
    {
        ...
        if (empty($form_pemeriksaan_pengukuran)) {
            ...
            $form_pemeriksaan_wiring->forms_id = $form->id;
            $form_pemeriksaan_pengukuran->arus_primer_r = $request->arus_primer_r;
            $form_pemeriksaan_pengukuran->arus_primer_s = $request->arus_primer_s;
            $form_pemeriksaan_pengukuran->arus_primer_t = $request->arus_primer_t;
            $form_pemeriksaan_pengukuran->arus_sekunder_r = $request->arus_sekunder_r;
            $form_pemeriksaan_pengukuran->arus_sekunder_s = $request->arus_sekunder_s;
            $form_pemeriksaan_pengukuran->arus_sekunder_t = $request->arus_sekunder_t;
            $form_pemeriksaan_pengukuran->ct_r = $request->ct_r;
            $form_pemeriksaan_pengukuran->ct_s = $request->ct_s;
            $form_pemeriksaan_pengukuran->ct_t = $request->ct_t;
            $form_pemeriksaan_pengukuran->akurasi_r = $request->akurasi_r;
            $form_pemeriksaan_pengukuran->akurasi_s = $request->akurasi_s;
            $form_pemeriksaan_pengukuran->akurasi_t = $request->akurasi_t;
            $form_pemeriksaan_pengukuran->voltase_primer_r = $request->voltase_primer_r;
            $form_pemeriksaan_pengukuran->voltase_primer_s = $request->voltase_primer_s;
            $form_pemeriksaan_pengukuran->voltase_primer_t = $request->voltase_primer_t;
            $form_pemeriksaan_pengukuran->voltase_sekunder_r = $request->voltase_sekunder_r;
            $form_pemeriksaan_pengukuran->voltase_sekunder_s = $request->voltase_sekunder_s;
            $form_pemeriksaan_pengukuran->voltase_sekunder_t = $request->voltase_sekunder_t;
            $form_pemeriksaan_pengukuran->cos_r = $request->cos_r;
            $form_pemeriksaan_pengukuran->cos_s = $request->cos_s;
            $form_pemeriksaan_pengukuran->cos_t = $request->cos_t;
            $form_pemeriksaan_pengukuran->akurasi = $request->akurasi;
            $form_pemeriksaan_pengukuran->keterangan = $request->keterangan;

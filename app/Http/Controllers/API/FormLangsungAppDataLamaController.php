    ...
    public function store(Request $request)
    {
        ...
        if ($form){
            $form->update([
                ...
                'foto_kwh_meter' => Storage::putFileAs('public/assets/dataAppLama/kwh', $request->foto_kwh_meter, 'foto_kwh_meter_'.$request->forms_id.'.'.$request->foto_kwh_meter->getClientOriginalExtension()),

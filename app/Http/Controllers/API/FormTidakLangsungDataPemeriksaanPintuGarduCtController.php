...
use App\Models\FormTidakLangsungDataPemeriksaanPintuGardu as form_model;
use App\Helpers\ResponseFormatter;
use Illuminate\Support\Facades\Storage;

class FormTidakLangsungDataPemeriksaanPintuGarduCtController extends Controller
{

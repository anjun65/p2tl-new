...
use App\Models\FormLangsungPemeriksaanPelindungKwh as form_model;

class FormLangsungPemeriksaanPelindungKwh extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($form){
            $form->update([
                ...
                'foto_sebelum' => Storage::putFileAs('public/assets/dataPemeriksaan/pelindungkwh/sebelum', $request->foto_sebelum, 'foto_sebelum_'.$request->forms_id.'.'.$request->foto_sebelum->getClientOriginalExtension()),
                ...
                'foto_sesudah' => Storage::putFileAs('public/assets/dataPemeriksaan/pelindungkwh/sesudah', $request->foto_sesudah, 'foto_sesudah_'.$request->forms_id.'.'.$request->foto_sesudah->getClientOriginalExtension()),
            ]);
        } else {

...
use App\Models\FormTidakLangsungDataPemeriksaanTutupTerminal as form_model;
use App\Helpers\ResponseFormatter;
use Illuminate\Support\Facades\Storage;

class FormTidakLangsungDataPemeriksaanTutupTerminalController extends Controller
{
